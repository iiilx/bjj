...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.seo_name'
        db.add_column('app_category', 'seo_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.seo_name'
        db.delete_column('app_category', 'seo_name')

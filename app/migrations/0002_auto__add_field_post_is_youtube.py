...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.is_youtube'
        db.add_column('app_post', 'is_youtube', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.is_youtube'
        db.delete_column('app_post', 'is_youtube')

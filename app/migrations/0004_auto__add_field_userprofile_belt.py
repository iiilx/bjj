...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.belt'
        db.add_column('app_userprofile', 'belt', self.gf('django.db.models.fields.CharField')(default='White', max_length='10'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.belt'
        db.delete_column('app_userprofile', 'belt')
    ...
    models = {
        'app.category': {
            ...
            'seo_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
        ...
        'app.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_youtube': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'app.userprofile': {
            ...
            'belt': ('django.db.models.fields.CharField', [], {'default': "'White'", 'max_length': "'10'"}),
